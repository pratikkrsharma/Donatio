...
<head>
    <title>Organization Login/SignIn</title>
...
<body style="background-color: #bc8888">
    ...
    <nav class="navbar navbar-default" style="margin-top: -10px; color: whitesmoke">
        ...
        <div class="navbar-header"  style="padding-left: 20px;">
            <a class="navbar-brand" href="index.html" style="color:whitesmoke"><i class="fa fa-home" aria-hidden="true"></i></a>        
        </div>
        <div>
...
<div class="container">
	...
	<div class="col-sm-5 background">
	<h4 style="text-align:left; color:white;font-size:40px; color:brown">ORGANISATION Sign Up</h4>
		<form class="form-group" action="clogin.php" method="post">
		<div class="form-group">
		<label  style="color: aliceblue;font-size:20px" >User ID</label>
		...
		<div class="form-group">
		<label  style="color: aliceblue;font-size:20px">Organisation name </label>
		...
		<input style="width: 70%" class="form-control" type="text"  name="phn" required/>
            ...
            <div class="form-group">
		<label  style="color: aliceblue;font-size:20px" >Card no</label>
		<input style="width: 70%" class="form-control" type="text"  name="phn" required/>
		</div>
		<div class="form-group">
